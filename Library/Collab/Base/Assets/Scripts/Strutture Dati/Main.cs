...
public static class Main
{
    ...
    public static class Level
    {
        ...
        public static void UpdateLevelScore(int level, int difficulty, int value)
        {
            ...
            if (Scores[level, difficulty] > Int32.Parse(Main.Level.InternetScores.Punteggio))
            {
            ...
            if (_audiosource)
            {
                switch (soundindex)
                {
                    ...
                    case Suoni.StartNewLevel:
                        {
                            PlayMusic(_audioscript.StartNewLevel);
                            break;
                        }
                    case Suoni.MainMenù:
                        {
    ...
    {
        public static void MostraPubblicitàCoin()
        {
            ADManager aD = GameObject.FindGameObjectWithTag("Pubblicità").GetComponent<ADManager>();
            aD.ShowAd(0);
        }

        public static void MostraPubblicitàEnergy()
        {
            ADManager aD = GameObject.FindGameObjectWithTag("Pubblicità").GetComponent<ADManager>();
            aD.ShowAd(1);
        }

        public static void MostraPubblicitàTime()
        {
            ADManager aD = GameObject.FindGameObjectWithTag("Pubblicità").GetComponent<ADManager>();
            aD.ShowAd(2);
        }
    ...
    public static void InitEverything(bool force)
    {
        ...
        if (returncode == -1 || force)
        {
            ...
            Player.InitScore();
            Player.InitCoins();
            EnergySuiteManager.Add(TimeValue.Energy, 15);
